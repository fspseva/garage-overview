...
class GarageAnalytics {
    constructor() {
        this.baseUrl = '/api'; // Use proxy endpoint to avoid CORS
        this.collections = {
    ...
    async fetchAllCollections() {
        try {
            ...
            // The API returns data directly, not wrapped in success property
            if (data.data && data.data.items) {
                // Return all collections, not just the ones in our hardcoded list
